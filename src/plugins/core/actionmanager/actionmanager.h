...
//
// Extracted from Qt Creator (coreplugin/actionmanager/actionmanager.h).
// The "MyIDE.MainWindow" friend reference is kept as a forward declaration; the
// real MainWindow class is defined in demo/app/ and is the ICore backend host.
